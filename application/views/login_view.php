...
<head>
    ...
    <title>Login — Exemplo Bootstrap 5</title>
                ...
                <div class="col-sm-10 col-md-8 col-lg-5">
                    <div class="card p-4">
                        ...
                        <div class="text-center mb-4">
                            ...
                            <p class="text-muted small">Entre na sua conta</p>
                        </div>
                        ...
                        <form id="loginForm" class="needs-validation" method='post'
                            action='<?= site_url('login/autenticar') ?>' novalidate>
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <div>
                                    <a href="<?= site_url('esqueceu_senha') ?>" class="link-secondary small">Esqueceu a
                                        senha?</a>
                                </div>
                            </div>
                            ...
                            <p class="mt-4 mb-0 text-center small">
                                Não tem conta? <a href="<?= site_url('cadastro') ?>" class="fw-semibold">Criar
                                    conta</a>
                            </p>
                        </form>
